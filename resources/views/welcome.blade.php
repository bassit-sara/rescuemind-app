                ...
                <div class="flex flex-wrap gap-4">
                    @auth
                        <a href="{{ route('sos.create') }}"
                            ...
                            <x-heroicon-o-lifebuoy class="w-5 h-5 inline-block shrink-0" /> กด SOS ขอความช่วยเหลือ
                        </a>
                        @if(auth()->user()->hasAnyRole(['super_admin', 'admin', 'officer', 'mental_officer', 'volunteer', 'volunteer']))
                        <a href="{{ route('dashboard') }}"
                            ...
                            <x-heroicon-o-chart-bar class="w-5 h-5 inline-block shrink-0" /> ไปยัง Dashboard
                        </a>
                        @endif
                    @else
                        <a href="{{ route('sos.create') }}"
        ...
        <div class="space-y-6 flex flex-col">
            ...
            <div class="bg-white rounded-[2rem] p-6 shadow-sm border border-gray-100 flex-1">
                <div class="flex items-center justify-between mb-4">
                    <h3 class="text-lg font-bold text-gray-800"><x-heroicon-o-phone class="w-5 h-5 inline-block mr-1 -mt-1" />️ สายด่วนฉุกเฉิน</h3>
                ...
                <div class="space-y-3">
                    <div class="flex items-center justify-between p-3 bg-gray-50 rounded-xl hover:bg-red-50 transition-colors cursor-pointer group">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-sm text-red-500 group-hover:text-red-600"><x-heroicon-o-truck class="w-5 h-5 inline-block mr-1 -mt-1" /></div>
                            <div>
                                <div class="font-bold text-gray-800 text-lg leading-none">1669</div>
                                <div class="text-xs text-gray-500">เจ็บป่วยฉุกเฉิน</div>
                            </div>
                        </div>
                        <a href="tel:1669" class="w-8 h-8 bg-red-100 rounded-full flex items-center justify-center text-red-600 opacity-0 group-hover:opacity-100 transition-opacity"><x-heroicon-o-phone class="w-5 h-5 inline-block mr-1 -mt-1" /></a>
                    </div>
                    <div class="flex items-center justify-between p-3 bg-gray-50 rounded-xl hover:bg-orange-50 transition-colors cursor-pointer group">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-sm text-orange-500 group-hover:text-orange-600"><x-heroicon-o-truck class="w-5 h-5 inline-block mr-1 -mt-1" /></div>
                            <div>
                        ...
                        <a href="tel:199" class="w-8 h-8 bg-orange-100 rounded-full flex items-center justify-center text-orange-600 opacity-0 group-hover:opacity-100 transition-opacity"><x-heroicon-o-phone class="w-5 h-5 inline-block mr-1 -mt-1" /></a>
                    </div>
                    <div class="flex items-center justify-between p-3 bg-gray-50 rounded-xl hover:bg-blue-50 transition-colors cursor-pointer group">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 bg-white rounded-full flex items-center justify-center shadow-sm text-blue-500 group-hover:text-blue-600"><x-heroicon-o-truck class="w-5 h-5 inline-block mr-1 -mt-1" /></div>
                            <div>
                                <div class="font-bold text-gray-800 text-lg leading-none">191</div>
                                <div class="text-xs text-gray-500">เหตุด่วนเหตุร้าย</div>
                            </div>
                        </div>
                        <a href="tel:191" class="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center text-blue-600 opacity-0 group-hover:opacity-100 transition-opacity"><x-heroicon-o-phone class="w-5 h-5 inline-block mr-1 -mt-1" /></a>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-[2rem] p-6 border border-blue-100 shadow-sm flex-shrink-0">
                <div class="flex items-start gap-4">
                    <div class="text-3xl"><x-heroicon-o-light-bulb class="w-5 h-5 inline-block mr-1 -mt-1" /></div>
                    <div>
                ...
                @foreach($alerts as $alert)
                    <a href="{{ route('alerts.show', $alert) }}"
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                <span class="text-2xl">{!! $alert->level == 3 ? '<span class="inline-block w-3 h-3 rounded-full bg-red-500 mr-1"></span>' : ($alert->level == 2 ? '<span class="inline-block w-3 h-3 rounded-full bg-orange-500 mr-1"></span>' : '<span class="inline-block w-3 h-3 rounded-full bg-yellow-500 mr-1"></span>') !!}</span>
                                <div>
